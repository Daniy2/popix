...
<head>
    ...
    <link rel="icon" type="site-icon" href="${pageContext.request.contextPath}/images/logo-noborderico.png">
...
<div class="container d-flex justify-content-center align-items-center min-vh-100">
    <div class="box-area row border rounded-5 p-4 bg-white shadow" style="max-width: 500px;">
        ...
        <form id="form-reg" method="post">
            ...
            <p class="text-center text-muted mt-5 mb-0">Possiedi già un account? <a href="login.jsp" class="fw-bold text-body"><u>Login</u></a></p>
        </form>
    </div>
</div>
</body>
